...
> Note: This repository is currently **under development**. The complete code and data regards to the manuscript will be released soon. During this period, please feel free to raise any question or discussion either via [issue](https://github.com/Immortals-33/Scaffold-Lab/issues) or [email](h2knight@sjtu.edu.cn)!

## Description

***

_*Scaffold-Lab*_ is the first unified framework for evaluating protein backbone generation.  
